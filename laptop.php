...
$sql1 = "INSERT into laptop(name,phonenumber,address,email,freetime,lpname,sversion,problem,pdescription) 
VALUES (
...
'{$mysqli->real_escape_string($_POST['lpname'])}',
...
if ($insert)
{
 Header("Location: submitlaptop.php");
}     
...
<div class="title fadeInLeftBig">
          ...
          <h1><i class = "fa fa-laptop"></i>  Laptops</h1>
</div>
</div>
...
<h1>Enter The Laptop Information</h1>
<br>
  <fieldset>
    <h3>Laptop Name</h3><input placeholder="Laptop Name" type="text" tabindex="5" name="lpname" required >
    </fieldset>

    <h3>Software Version</h3><fieldset>
    <input placeholder="Enter Sotware Version(i.e windows,osx,ubuntu)" type="text" tabindex="7" name="sversion" >
    </fieldset>
  ...
  <option value="spoiledcamerafront">Spoiled camera(front)</option>
  ...
  <option value="spoiledmousepad">mouse pad problems</option>
  <option value="softwaremalfunction">software malfunction</option>
