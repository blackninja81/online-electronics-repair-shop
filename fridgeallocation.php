...
$output = NULL;
//query the database
$query = $mysqli->query("SELECT * FROM employeedtails where specialize = 'fridge'") or die("cant search");
...
<?php
  {
  $sqlz =  "INSERT into allocation (name,phonenumber,address,sname,lname,pnumber,id,email,problem,freetime) 
